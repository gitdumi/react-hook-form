  ...
  switch (inputType) {
    ...
    case "radio":
      return (
        ...
        <div className="inline">
          <input {...register(inputName)} type={inputType} value={"white"} name={inputName} defaultValue={null}/>
          <label>white</label>
          </div>
          <div className="inline">
          <input {...register(inputName)} type={inputType} value={"black"} name={inputName} defaultValue={null}/>
          <label>black</label>
          </div>
          {errors[inputName]?.message && <p>{errors[inputName]?.message}</p>}
        </>
